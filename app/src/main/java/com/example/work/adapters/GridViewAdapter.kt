...
import com.example.work.holders.HolderEnd
import com.example.work.holders.HolderHeader
import com.example.work.holders.HolderOne
...
class GridViewAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            ...
            ITEM__1 -> {
                view = LayoutInflater.from(mContext).inflate(R.layout.holder_views_change, null, false)
                HolderOne(view)
            }
            ITEM__2 -> {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        when {
            ...
            mDataList[myPosition][MainActivity.TYPE_1] == "third" -> (holder as HolderOne).textThree?.text =
                mDataList[myPosition][MainActivity.TYPE_2]


            mDataList[myPosition][MainActivity.TYPE_1] == "first" -> {
                (holder as HolderOne).textOne?.text = mDataList[myPosition][MainActivity.TYPE_2]
                holder.textTwo?.text = mDataList[myPosition][MainActivity.TYPE_3]
                holder.textThree?.text = mDataList[myPosition][MainActivity.TYPE_4]
            }


            mDataList[myPosition][MainActivity.TYPE_1] == "second" -> (holder as HolderOne).textTwo?.text =
                mDataList[myPosition][MainActivity.TYPE_2]
        }
